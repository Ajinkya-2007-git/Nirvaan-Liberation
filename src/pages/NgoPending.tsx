  ...
  return (
    <div className="min-h-screen bg-ink">
      ...
      <div className="mx-auto flex max-w-md flex-col items-center justify-center gap-3 px-6 py-24 text-center">
        <h1 className="font-display text-2xl font-semibold text-paper">Under review</h1>
        <p className="text-muted">Your organization is under review. You'll be notified once approved.</p>
      </div>
    </div>
  );
}
